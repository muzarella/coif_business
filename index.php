...
<!-- container  start for form    -->
 <div class="container">
   ...
   <?php
  if (isset($error)){
     echo " <div id='error_msg' class='alert alert-success'> <strong> Error</strong>". @$error ."</div>"; 
unset($_SESSION['error']) ;
  }  
...
<form method="POST" action="include/add_users.php">
...
<input  type="text" name="username" class="form-control col-sm-6" placeholder="Enter your username here... " required />
</div>
...
<div class="form-group col-md-12">
	<label> city </label>
<input  type="text" name="city" class="form-control col-sm-6" placeholder="Enter your city here... " required />
</div>

<div class="form-group col-md-12">
  <label> Area </label>
<input  type="text" name="area" class="form-control col-sm-6" placeholder="Enter your area here... " required />
</div>
